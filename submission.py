...
parser.add_argument('--save_path', type=str, default='./results/kitti2012/benchmark', help='the path of saving checkpoints and log')
...
parser.add_argument('--datapath2012', default='/Users/Divya/Downloads/kitti12/testing/', help='datapath')
parser.add_argument('--datatype', default='2012', help='finetune dataset: 2012')

parser.add_argument('--pretrained', default='\\Users\\Divya\\Downloads\\BIG LN (1)\\BIG LN\\results\\checkpoint_49.tar',
                    help='loading model')
